...
with tab2:
    if 'poligono_usuario' not in st.session_state:
        ...
        with col_res:
            ...
            if is_rescate:
                st.warning("⚠️ El área de la parcela es muy pequeña. Se han generado 3 puntos de control.")
            ...
            # Evitamos dividir por cero si el área es muy pequeña
            if area_m2 > 0:
            ...
            with col_tabla:
                ...
                # Pasamos hide_index=True para quitar la columna lateral extraña
